  ...
  return (
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl">
                Watch on Smart TVs, PlayStation, Xbox, Chromocast, Apple TV, Blu-ray players, and more.
              </p>
            </div>
    ...
    {/* separator */}
     ...
     <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl">
                Stream unlimited movies and TV shows on your phone, tablets, laptop, oand TV.
              </p>
            </div>
     ...
     <div className="h-2 w-full bg-[#232323]" aria-hidden='true'/>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6pxl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
            ...
            <div className="flex-1 text-center md:text-left">
                <h2 className="text-4xl md:text-5xl font-extrabold md-4">Create profiles for kids</h2>
                <p className="text-lg md:text-xl">
